...
//
//Some of the tests towards the bottom got a little confusing. Once I got into a rhythm of adding objects to objects it wasn't all that bad. I think I will just need to get used to some of these new data structures with some practice.

// Adding/deleting some of the object values took a little googling around. Once I got a little help from google, it took a few tries for me to get it down. Again, I think i'll just need some practice.

// Manipulating objects reminded me a little bit of the nested data structures from Ruby. It takes a few seconds to get used to working with, but once you get the hang of it, its not that bad.
//
//
//
//
